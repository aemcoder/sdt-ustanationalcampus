...
const ledger={}; for (const f of ['deploy-ledger.json','redrive-ledger.json','redrive2-ledger.json','redrive3-ledger.json','redrive4-ledger.json']) { const p='stardust/.work/delivery/'+f; if (fs.existsSync(p)) Object.assign(ledger, JSON.parse(fs.readFileSync(p,'utf8'))); }
